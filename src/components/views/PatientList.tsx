            ...
            <div className="client-panel p-5 md:p-6">
                <div className="flex flex-col lg:flex-row gap-5 justify-between items-start lg:items-center">
                    <div>
                        ...
                        <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight">Patients</h1>
                        <p className="text-slate-500 text-sm mt-1">View pets, open medical profiles, and add a new patient.</p>
                    </div>
